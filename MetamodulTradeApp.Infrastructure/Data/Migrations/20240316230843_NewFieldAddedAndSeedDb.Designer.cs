...
namespace MetamodulTradeApp.Infrastructure.Migrations
{
    ...
    [Migration("20240316230843_NewFieldAddedAndSeedDb")]
    partial class NewFieldAddedAndSeedDb
    {
            ...
            modelBuilder.Entity("MetamodulTradeApp.Infrastructure.Data.Models.ClientRequest", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedOn = new DateTime(2023, 10, 17, 1, 8, 43, 386, DateTimeKind.Local).AddTicks(8065),
                        ...
                        {
                            Id = 2,
                            CreatedOn = new DateTime(2023, 10, 17, 1, 8, 43, 386, DateTimeKind.Local).AddTicks(8099),
                            CreatorId = "506cd08d-e8d0-4d5c-9796-949558867648",
                        ...
                        {
                            Id = 3,
                            CreatedOn = new DateTime(2024, 1, 17, 1, 8, 43, 386, DateTimeKind.Local).AddTicks(8103),
            ...
            modelBuilder.Entity("MetamodulTradeApp.Infrastructure.Data.Models.Comment", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedOn = new DateTime(2023, 10, 17, 1, 8, 43, 386, DateTimeKind.Local).AddTicks(9262),
                            CreatorId = "ece06352-f235-4345-94a7-1a2c12f03ac6",
                            PostId = 1,
                        ...
                        {
                            Id = 2,
                            CreatedOn = new DateTime(2023, 10, 17, 1, 8, 43, 386, DateTimeKind.Local).AddTicks(9268),
                            CreatorId = "ece06352-f235-4345-94a7-1a2c12f03ac6",
                            PostId = 1,
                        ...
                        {
                            Id = 3,
                            CreatedOn = new DateTime(2023, 12, 17, 1, 8, 43, 386, DateTimeKind.Local).AddTicks(9271),
                            CreatorId = "506cd08d-e8d0-4d5c-9796-949558867648",
                            PostId = 3,
            ...
            modelBuilder.Entity("MetamodulTradeApp.Infrastructure.Data.Models.Post", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedOn = new DateTime(2023, 5, 17, 1, 8, 43, 386, DateTimeKind.Local).AddTicks(9144),
                            CreatorId = "ece06352-f235-4345-94a7-1a2c12f03ac6",
                        ...
                        {
                            Id = 2,
                            CreatedOn = new DateTime(2023, 11, 17, 1, 8, 43, 386, DateTimeKind.Local).AddTicks(9159),
                            CreatorId = "ece06352-f235-4345-94a7-1a2c12f03ac6",
                        ...
                        {
                            Id = 3,
                            CreatedOn = new DateTime(2024, 2, 17, 1, 8, 43, 386, DateTimeKind.Local).AddTicks(9162),
                            CreatorId = "ece06352-f235-4345-94a7-1a2c12f03ac6",
            ...
            modelBuilder.Entity("MetamodulTradeApp.Infrastructure.Data.Models.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CategoryId = 2,
                            CreatedOn = new DateTime(2023, 12, 17, 1, 8, 43, 386, DateTimeKind.Local).AddTicks(9403),
                            CreatorId = "ece06352-f235-4345-94a7-1a2c12f03ac6",
                        ...
                        new
                        {
                            Id = 2,
                            CategoryId = 1,
                            CreatedOn = new DateTime(2023, 12, 17, 1, 8, 43, 386, DateTimeKind.Local).AddTicks(9408),
                            CreatorId = "ece06352-f235-4345-94a7-1a2c12f03ac6",
